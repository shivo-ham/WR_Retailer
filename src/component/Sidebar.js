          ...
          <View style={{ backgroundColor: colors.primary, height: 180 }}>
            ...
            <View style={{ paddingVertical: 10, marginTop: 16, width: '76%', alignSelf: 'flex-start', flexDirection: 'row', justifyContent: 'space-between' }}>
              ...
              <View style={{ paddingHorizontal: 10 }}>
                ...
                <View style={{ height: 62, width: 65, elevation: 0 }}>
                ...
                <TouchableOpacity onPress={this.selectPhotoTapped.bind(this)}
                  style={{ height: 28, width: 28, justifyContent: 'center', alignItems: 'center', borderColor: 'white', borderWidth: 1, position: 'absolute', left: 52, bottom: 25, borderRadius: 14, elevation: 0 }}>
            ...
            renderItem={({ item }) =>
              <View style={{ padding: 10 }}>
                  ...
                  style={{ flexDirection: 'row', alignItems: 'center' }}>
                    {item.navigate ?
                      <Icon style={{ flex: 1 }} name={item.icon} size={25} color={colors.black} />
                      : null}
